...
class VFuncFilter(object):
    ...
    def apply(self, src, dst):
        """ Apply the filter wth a BGR or gray source/destination."""
        srcFlatView = utils.flatView(src)
        dstFlatView = utils.flatView(dst)
        utils.applyLookupArray(self._vLookupArray, src.FlatView, dstFlatView)
...
class BGRFuncFilter(object):
    ...
    def apply(self, src, dst):
        ...
        utils.applyLookupArray(self._rLookupArray, g, r)
        cv2.merge([b,g,r], dst)
